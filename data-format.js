...
// Framatome > FRAMATOME
// EDF Holding SAS > EDF HOLDING SAS
const raw = {
  total_count: 56,
  results: [
    {
...
fs.writeFile("data.js", "let data =", (error) => {
  if (error) throw error;
});

fs.appendFile("data.js", JSON.stringify(subsidiaries, null, 2), (err) => { if (err) 
  throw err;
}
);

fs.appendFile("data.js", ";export default data;", (err) => { if (err) 
  throw err;
}
);